 ...
 */
String ADMOSCProtocolProcessor::GetRemoteObjectDomainString()
{
	return "/adm/src/";
}
 ...
 */
String ADMOSCProtocolProcessor::GetRemoteObjectParameterTypeString(RemoteObjectIdentifier id)
{
	switch (id)
	{
	case ROI_Positioning_SourceSpread:
 ...
 */
void ADMOSCProtocolProcessor::createRangeMappedFloatMessageData(const OSCMessage& messageInput, RemoteObjectMessageData& newMessageData, float mappingRangeMin, float mappingRangeMax)
{
